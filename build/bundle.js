...
var _bootstrap = __webpack_require__(21);
...
var _contactStore = __webpack_require__(34);

var _contactStore2 = _interopRequireDefault(_contactStore);

var _contactList = __webpack_require__(42);

var _contactList2 = _interopRequireDefault(_contactList);

var _contactAddForm = __webpack_require__(46);

var _contactAddForm2 = _interopRequireDefault(_contactAddForm);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_toggle2.default, { key: 1, css: 'oi oi-plus', icon: 'plus', component: _react2.default.createElement(_contactAddForm2.default, { store: this.props.store }) }),
                _react2.default.createElement(_contactList2.default, { store: this.props.store })
            );
        }
    }]);
...
var store = new _contactStore2.default();

_reactDom2.default.render(_react2.default.createElement(App, { store: store }), document.getElementById("container"));
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(9),B=__webpack_require__(10),C=__webpack_require__(2),ba=__webpack_require__(11),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ia=__webpack_require__(15),D=__webpack_require__(3);
...
var ContactStore = (_class = function () {
    ...
    _createClass(ContactStore, [{
        key: 'load',
        value: function load() {
            var _this = this;

            _superagent2.default.get('http://localhost:3000/contacts/all').set('Accept', 'application/json').end(function (error, results) {
                if (error) console.error(error);else {
                    console.log("STORE > Server response body: " + results.text);
                    var data = JSON.parse(results.text);
                    _this.contacts.splice(0, _this.contacts.length);
                    for (var i = 0; i < data.length; i++) {
                        _this.contacts.push(data[i]);
                    }
                }
            });
        }
        ...
        value: function add(contact) {
            ...
            _superagent2.default.post('http://localhost:3000/contacts/add').set('Accept', 'application/json').send(contact).end(function (error, results) {
                if (error) console.error(error);else {
                    console.log("STORE > Server response body: " + results.text);
                }
            });
    ...
    return ContactStore;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'contacts', [_mobx.observable], {
    enumerable: true,
...
var _contactSearchForm = __webpack_require__(44);

var _contactSearchForm2 = _interopRequireDefault(_contactSearchForm);
...
var ContactList = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(ContactList, [{
        ...
        key: 'filterContacts',
        value: function filterContacts(text) {
            var filteredData = [];

            if (text.length > 0) {
                this.props.store.contacts.map(function (item) {
                ...
                this.setState({ data: this.props.store.contacts });
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (this.state.data.length == 0) {
                ...
                components = this.state.data.map(function (item) {
                    return _react2.default.createElement(_contact2.default, { key: item.id, json: item });
                });
            }
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_contactSearchForm2.default, { filterContactListHandler: this.filterContacts }),
                _react2.default.createElement(
                    'ul',
                    { className: 'list-group text-center contacts-list' },
                    components
                )
            );
        }
...
var SearchContact = function (_React$Component) {
    _inherits(SearchContact, _React$Component);

    function SearchContact(props) {
        _classCallCheck(this, SearchContact);

        var _this = _possibleConstructorReturn(this, (SearchContact.__proto__ || Object.getPrototypeOf(SearchContact)).call(this, props));
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { 'class': 'form-group' },
                    _react2.default.createElement('input', { type: 'text', 'class': 'form-control col-sm-12 adjust-margin', name: 'search', placeholder: 'Search...',
...
var AddContact = function (_React$Component) {
    ...
    _createClass(AddContact, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'form',
                { onSubmit: this.handleSubmit, 'class': 'form-inline', ref: 'formContact' },
                _react2.default.createElement(
                    'div',
                    { 'class': 'form-group' },
                    _react2.default.createElement('input', { type: 'text', 'class': 'form-control col-sm-12 adjust-margin', name: 'name', placeholder: 'Name',
                        value: this.state.name, onChange: this.handleChange })
                ),
                _react2.default.createElement(
                    'div',
                    { 'class': 'form-group col-xs-offset-0' },
                    _react2.default.createElement('input', { type: 'text', 'class': 'form-control col-sm-12 adjust-margin', name: 'number', placeholder: 'Number',
                        value: this.state.number, onChange: this.handleChange })
                ),
                _react2.default.createElement(
                    'button',
                    { type: 'submit', 'class': 'btn btn-primary adjust-margin' },
                    'Save'
                )
            );
        }
...
var Toggle = function (_React$Component) {
    ...
    _createClass(Toggle, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "clearfix toggle-area c-height-50" },
                _react2.default.createElement(
                    "div",
                    { className: "pull-left adjust-margin adjust-icon-position" },
                    _react2.default.createElement("span", { onClick: this.handleClick, className: this.props.css, "data-glyph": this.props.icon })
                ),
                _react2.default.createElement(
                    "div",
                    { className: isComponentHidden },
